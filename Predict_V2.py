...
class Predict(object) :
	...
	def workspace(self) :
		...
		mots_pos_plus=["should see","should watch","recommend","fascinating","unforgettable","hilarious","fantastic","thrilling","recommended","amazing","excellent","excellently","delightful","marvellous","brilliant","delight","finest","joyous","genius","masterfully","great","greatest","masterpiece","awesome","sublime","wonderful","excellently","witty","irresistible","best","must-see","must see","praise","outstanding"]
		...
		expression_neg=["could have been","should have been","nothing more than","over and over","the problem is that","waste of time","the whole thing","to begin with","might as well","what the hell","the whole movie","too bad that","saving grace","not to say"]
